                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="{{ route('employee.store') }}" enctype="multipart/form-data">                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="firstname" class="form-label">Employee ID Number    </label>
                                                <input type="number" name="idnumber" class="form-control @error('idnumber') is-invalid @enderror"   >
                                                @error('idnumber')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="driving" class="form-label">Has Valid Driving Licence?   </label>
                                                <select name="driving" class="form-select @error('driving') is-invalid @enderror" id="example-select">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="example-fileinput" class="form-label">Employee ID Card</label>
                                                <input type="file" name="idphoto" id="idphoto" class="form-control">
                                            </div>
                                        </div> <!-- end col -->
