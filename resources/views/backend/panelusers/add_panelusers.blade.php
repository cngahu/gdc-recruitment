                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="post" action="{{ route('panel.store') }}" >
                                    ...
                                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Add Shortlisting Panel User</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select   type="text" name="panel_role" class="form-control @error('panel_role') is-invalid @enderror" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                            <label for="inputLastName2" class="form-label"  >Vacancy Name</label>
                                            <div class="form-group">
                                                <select name="vacancy_id"  id="vacancy_id" required="" class="form-control">
                                                    <option value="" selected="" disabled="">Select </option>
                                                    @foreach($vacancy as $item)
                                                        <option value="{{$item->id }}" {{$item->vacancy_id==$item->id ? 'selected':'' }}>{{$item->jobTitle}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
