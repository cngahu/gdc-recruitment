...
<head>
    ...
    <meta content="A fully featured recruitment system for ICT Authority" name="description" />
...
<body style="background-color:dimgrey ;background-size: cover;">
...
<footer class="footer footer-alt">
    2024 - <script>document.write(new Date().getFullYear())</script> &copy; ICTA by <a href="" class="text-white-50">ICTA</a>
</footer>
