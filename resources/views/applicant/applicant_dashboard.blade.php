...
{{--    {{asset('backend/')}}--}}
    <meta charset="utf-8" />
    <title>Applicant Dashboard | PSASB </title>
...
{{--<script src="https://cdn.tiny.cloud/1/v82m201wkdbx51zd7ntfrqx4nk46t91jugfexv5ofxqr18rx/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>--}}
...
<script>
    $('form').on('beforeSubmit', function(){
        ...
        submit.html('<span class="fa fa-spin fa-spinner"></span> Processing... please wait');
