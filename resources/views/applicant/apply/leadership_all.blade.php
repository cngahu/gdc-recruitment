...
@section('applicant')
    ...
    <div class="row">
        <h5 style="color:seagreen">Step 6 of 7</h5>

        <div class="col-lg-8 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Add Leadership Course</h5>

                    <div class="alert alert-info text-center" role="alert">
                        <p>Dear Applicant, please ensure to add any relevant leadership courses you have attended, including but not limited to:</p>
                       <p>Senior Management Course (SMC),Senior Leadership Course (SLDP),Supervisory Course,And any other leadership development course.</p>

                        <p>Fields marked with a <span style="color: red;">*</span> are mandatory for successful submission. Kindly provide the necessary details and proceed accordingly.</p>
                    </div>

                    <div class="row">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="customCheck1"  >
                            <label class="form-check-label" style="color: red" for="customCheck1">Click Here If You Have No Leadership Course</label>
                        </div>
                    ...
                    <div class="tab-pane" id="proffqualsdiv">
                        <form method="post" id="myForm" action="{{ route('leadership.store') }}" enctype="multipart/form-data">                                    @csrf
                            @csrf
...
{{--                            <input type="hidden" name="id" id="url_path_confirm" value="{{$url_confirm}}">--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 form-group">
                                        <label for="firstname" class="form-label">Learning Institution Name <span style="color: red;">*</span></label>
                        ...
                        @if(count($lc_qual)==0)
                            ...
                            @else
                                <div class="text-end">
                                    ...
                                    <a href="{{route('applicant.experience')}}" class="btn btn-primary">Previous</a>
                    ...
                    <div class="" id="proceed">
                        <form method="post" action="{{route('leadership.noquals')}}">
                            @csrf
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-0">My Leadership Courses</h4>
                        ...
                        <div class="table-responsive pt-3">
                            <table class="table table-centered table-nowrap table-borderless mb-0">
                                ...
                                <tr class=".table-striped">
                                    ...
                                    <td>
                                        <a href="{{route('leadership.edit',$item->id)}}" class="btn btn-primary"><i class="material-symbols-outlined">edit</i></a>
                                        <a href="{{route('leadership.delete',$item->id)}}" class="btn btn-danger"  id="delete" ><i class="material-symbols-outlined">delete</i></a>
   ...
   @elseif(($ccount==0)&&($user->leadership==0)&&($user->level >= 6))
       <div class="col-12">
           <!-- Portlet card -->
           <div class="card">
               <div class="card-body">
                   ...
                   <h4 class="header-title mb-0">My Leadership Course</h4>
                   <br>
                   <div class="alert alert-warning bg-warning text-white border-0" role="alert">
                       <strong>You Do Not Have Any Leadership Courses ! </strong>
                   </div>
                   <div>
                       <a href="{{route('applicant.experience')}}" class="btn btn-primary">Previous</a>
