        ...
        <div class="col-lg-8 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-pane">
                        <form method="post" id="myForm" action="{{ route('leadership.update') }}" enctype="multipart/form-data">                                    @csrf
                                @csrf
                            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Update Leadership Details</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 form-group">
                                        <label for="firstname" class="form-label">Learning Institution Name</label>
