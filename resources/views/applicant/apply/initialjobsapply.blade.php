        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <form method="post" id="myForm" action="{{ route('jobsapply.save') }}" enctype="multipart/form-data">                                    @csrf
                            ...
                            @foreach($uploaddocs as $key=> $item)
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="file" name="fileid[{{$item->document_id}}]"  class="form-control"  accept="application/pdf" onchange="mypdfcheck()">
                                    </div>
                                </div> <!-- end col -->
