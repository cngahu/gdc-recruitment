                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Applicant Profile</a></li>
                ...
                <div class="col-lg-4 col-xl-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <h4 class="mb-0">    {{ $adminData->first_name }}  {{ $adminData->other_name }}  </h4>
                            ...
                            <div class="text-start mt-3">
                                ...
                                <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ms-2">    {{ $adminData->first_name }}  {{ $adminData->other_name }}  </span></p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control" id="firstname" value="{{ $adminData->first_name }}" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
