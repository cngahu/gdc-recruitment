...
use App\Http\Controllers\Recruitment\LeadershipCourseController;
use App\Http\Controllers\Backend\ReportBuilderController;
use App\Http\Controllers\Backend\LonglistReportsController;
...
Route::controller(VacanciesController::class)->group(function () {
    ...
    Route::get('/delete/vacancies/{id}', 'deleteVacancy')->name('delete.vacancy');
    Route::get('/details/vacancies/{id}', 'VacancyDetailsAdmin')->name('details.vacancy');
...
Route::middleware(['auth','verified','role:admin'])->group(function () {
    ...
    Route::controller(AdminController::class)->group(function () {
        ...
        Route::get('/shortlistfinal',  'ShortlistFinal')->name('shortlist.final');
    ...
    Route::controller(DashboardController::class)->group(function () {
        ...
        Route::get('/vdashboard-report',  'ApplicationsReport')->name('vacancy.applications');
        Route::get('/vdashboard-report-pdf', 'ApplicationsReportPdf')->name('vacancy.applications.pdf');
        ...
        Route::get('/ethnicities', 'ethnicities');
          Route::get('/countysummary/{id}',  'CountySummary')->name('countySummary');
    ...
    Route::prefix('builder')->controller(ReportBuilderController::class)->group(function () {
        // Define your routes here, e.g.:   Route::get('/', 'index');
        Route::get('/', 'index')->name('builder.index');
        Route::get('/longlist', 'longlistIndex')->name('builder.longlist.index');

        Route::get('/county-vacancies', 'countyVacanciesReport')->name('county.vacancies.report');
        Route::post('/generate-report',  'generateReport')->name('generateReport');
        Route::get('/reports/generate','generateReportPdf')->name('generateReportPdf');
        Route::get('/reports/longlist-generate','generateLonglistReportPdf')->name('generateLonglistReportPdf');


    });
    Route::prefix('builder')->controller(LonglistReportsController::class)->group(function () {

        Route::get('/admin/reports',  'listReports')->name('admin.reports.index');
        Route::get('/admin/reports/download/{fileName}', 'downloadReport')->name('admin.reports.download');
    ...
    Route::controller(PanelUsersController::class)->group(function () {
        ...
        Route::get('/all/emails', 'AllUnverified')->name('all.unverified');
        ...
        Route::get('/admin/verify/{id}', 'AdminVerify')->name('admin.verify');
...
Route::middleware(['auth','verified','role:applicant'])->group(function () {
    ...
    Route::controller(AdminController::class)->group(function () {
        ...
        Route::get('/applicant/change/password',  'FirstTimeChangePassword')->name('first.change.password');
        Route::post('/fupdate/password', 'FirstUpdatePassword')->name('first.update.password');
    ...
    Route::controller(LeadershipCourseController::class)->group(function () {
        Route::get('applicant/leadership-course',  'LeadershipCourseProfile')->name('applicant.leadership');
        Route::post('leadership-course/store',  'LeadershipCourseStore')->name('leadership.store');
        Route::get('leadership-course/edit/{id}' , 'LeadershipCourseEdit')->name('leadership.edit');
        Route::post('leadership-course/update' , 'LeadershipCourseUpdate')->name('leadership.update');
        Route::get('leadership-course/delete/{id}' , 'LeadershipCourseDelete')->name('leadership.delete');
        Route::post('leadership-course/noquals',  'LeadershipCourseNoQualsStore')->name('leadership.noquals');
    ...
    Route::controller(JobApplicationController::class)->group(function () {
        ...
        Route::get('dashboard/openvacancies',  'DashboardOpenVacancies')->name('dashboard.openvacancies');

        Route::get('job/apply/{id}',  'VacancyApply')->name('jobs.apply');
        Route::get('job/dapply/{id}',  'DVacancyApply')->name('dashboard.jobs.apply');
...
Route::middleware(['auth','verified','role:panelist'])->group(function () {
    ...
    Route::controller(AdminController::class)->group(function () {
        ...
        Route::get('/panelist/first-time',  'PanelistFirstTime')->name('panelist.firsttime');
        Route::post('/p-update/password', 'FirstUpdatePassword')->name('panelist.first.update.password');
